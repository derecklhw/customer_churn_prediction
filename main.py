...
def explain_prediction(probability, input_dict, surname):
  ...
  - Your explanation should be based on the customer's information, the summary statistics of churned and non-churned customers, and the feature importances provided.
    ...
    Don't mention the probability of churning, or the machine leanring model, or say anything like "Based on the machine learning model's prediction and top 10 most important features", just explain the prediction.
...
def generate_email(probability, input_dict, explanation, surname):
  prompt = f"""You are a manager at HS Bank. You are responsbile for ensuring customers stay with the bank and are incentivized with various offers.
...
if selected_customer_option:
  ...
  print("Selected customer surname:", select_surname)
